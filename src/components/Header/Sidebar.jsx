                ...
                <div className="text-white lg:w-56 md:w-44 w-16 sm:p-3 p-2 border-slate-600 border-r h-screen flex flex-col justify-between">
                    <div className="flex flex-col gap-4 mt-5">
                        {sidebarTopItems.map((item) => (
                            ...
                            >
                                <div className="flex items-center rounded-md outline-0 overflow-hidden gap-2 justify-center sm:justify-start hover:bg-purple-500 cursor-pointer py-1 px-2 border border-slate-600">
                                    {item.icon}
                    ...
                    <div className="space-y-4 mb-10">
                        {username && (
                            <div
                                className="flex items-center gap-2 rounded-md outline-0 overflow-hidden justify-center sm:justify-start hover:bg-purple-500 cursor-pointer py-1 px-2 border border-slate-600"
                                onClick={() => logout()}
                            >
                                <IoMdLogOut size={25} />
                                <span className="text-base hidden md:block">
                        ...
                        <div className="flex items-center gap-2 rounded-md justify-center sm:justify-start hover:bg-purple-500 cursor-pointer py-1 px-2 border border-slate-600">
                            <CiSettings size={25} />
                            <span className="text-base hidden md:block">
                                Settings
                            </span>
